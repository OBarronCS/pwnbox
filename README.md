...
The pre-built Docker image created from the `Dockerfile` in this repo can be found at [`ghcr.io/obarroncs/pwnbox`](https://github.com/OBarronCS/pwnbox/pkgs/container/pwnbox). There are multiple variants:
```sh
